...
return [
    ...
    'title' => "HNG Stage 0 API Task - Laravel Backend Docs",

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'This API documentation is auto-generated by [Scribe](https://scribe.knuckles.wtf/), ensuring it always reflects the current state of the API. For detailed endpoint specifications, request parameters, and response examples, please refer to the Scribe-generated docs.',
